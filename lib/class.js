...
// This fires before all the inquirer data is returned
let employeeHtml;
fs.readFile('./dist/employees.html', (err, data) => {
    if (err) {
        console.log(err)
    } else {
        employeeHtml = data;
...
fs.writeFile('./dist/index.html', htmlGenerator(employeeHtml), (err) => {
    console.error(err);
})
